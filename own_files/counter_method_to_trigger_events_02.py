...
def lead_change(a=0):
    if a == 1:
        p1 >> prophet(lp1[0], dur=0.5, sus=0.2, oct=5)
        # print("change 0")
    if a == 9:
        p1 >>  prophet(lp1[1], dur=0.5, sus=0.2, oct=5)
        # print("change 8")
    if a == 17:
        p1 >> prophet(lp1[2], dur=0.5, sus=0.2, oct=5)
        # print("change 16")
    if a == 25:
        p1 >> prophet(lp1[3], dur=0.5, sus=0.2, oct=5)
        # print("change 24")        
