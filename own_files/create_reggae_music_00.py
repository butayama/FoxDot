...
lead_pattern1a = P[_, _, (9,12,16), (11), _, _, (4,7,11), (9)]
...
p1 >> prophet(lead_pattern4.stutter(2), dur=0.5, sus=[0.15, 0.1], oct=5)

p1 >> prophet(lead_pattern4, dur=0.5, sus=[0.15, 0.1], oct=5)

p1 >> prophet(lead_pattern1, dur=0.5, sus=[0.15, 0.1], oct=5)
...
def lead_change(a=0):
    if a == 0:
        p1 >> prophet(lp1[0], dur=0.5, sus=0.15, oct=5)
        # print("change 0")
    elif a == 8:
        p1 >> prophet(lp1[1], dur=0.5, sus=0.15, oct=5)
        # print("change 8")
    elif a == 16:
        p1 >> prophet(lp1[2], dur=0.5, sus=0.15, oct=5)
        # print("change 16")
    elif a == 24:
        p1 >> prophet(lp1[3], dur=0.5, sus=0.15, oct=5)
        # print("change 24")     
