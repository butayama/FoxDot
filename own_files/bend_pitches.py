...
p2 >> pluck([0,1,3], dur=4, slide=0.1, bend=0.6)

p2 >> dirt([0,1,3], slide=0.5, bend=0.6, dist=0.01, dur=16)

p2 >> dirt([0,1,3,5,8,13,21], slide=0.1, bend=0.1, dist=0.01, dur=3, chop=0, sus=6)

p3 >> sitar([0,1,3,5,8,13,21], slide=0, bend=4, dist=0.1, dur=16, echo=3, room=0.9, coarse=32, mix=0.1)

Nice Bell

p5 >> bell(P[0,2,5,6, [(0, 2, 5), 9, 11, 12,(2, 4, 5, 8)]] + P[0,3, 4, 5].stutter(), dur=PDur([5,2,3],8), oct=6, room=0.6, verb=0.6, slide=4, bend=4, dist=0.1, echo=0, coarse=20, mix=0.1)

p5 >> jbass(P[0,2,5,6, [(0, 2, 5), 9, 11, 12,(2, 4, 5, 8)]] + P[0,3, 4, 5].stutter(0), dur=PDur([8,12,16]), coarse=1, oct=5, room=2, bend=4, verb=0, mix=0.3)
...
p2 >> play("C", dur=2, pshift=[0, (0,4,7)], sample=3, echo=1, room=0.8, mix=0.8)
...
p1 >> dirt([0,2], pshift=[(0,3,7), (0,4,7)], dist=0.5, dur=4) + (0,1)

p2 >> dirt([0,1,3], dist=0.01, dur=16) + (0,1)
