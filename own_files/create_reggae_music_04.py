...
bass_01_dur = [rest(1),0.75,rest(0.25),0.5,0.5,0.5,0.5]

bass_01 >> bass(bass_01_pitch, dur=bass_01_dur, oct=4, pan=0.3, room=0.1, verb=0.1, sus=[rest(1),0.75,rest(0.25),0.5,0.5,0.5,0.5])
